...
single_client_throughput = importlib.import_module("lanforge-scripts.py-scripts.tip-cicd-sanity.single_client_throughput")
import cloudsdk
...
throughput_profiles = importlib.import_module("lanforge-scripts.py-scripts.tip-cicd-sanity.throughput_profiles")
