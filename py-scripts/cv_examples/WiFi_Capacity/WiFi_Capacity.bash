...
#
# PURPOSE:
#   Automation script to run the 'WiFi Capacity' Chamber View test.
#
# USAGE:
#   ./WiFi_capacity.bash
#
...
#     - Runs the 'WiFi capacity' test, saving generated reports
#
...
TEST_CFG=WiFi_Capacity.cfg                  # 'WiFi Capacity' test config file. If not specified in test script
                                            # CLI, then any unspecified options will use default test values.

RPT_DIR=/tmp/WiFi_Capacity_reports          # Output directory for generated reports and associated data

# Chamber View Scenario name
CV_SCENARIO_NAME=WiFi_Capacity_Automated_Test
...
DUT_NAME=WiFi_Capacity_DUT                  # Name of DUT as it appears in report
...
#   - Five AUTO 802.11 mode STAs on radio wiphy0 which will associate to the
...
$LF_PY_SCRIPTS/create_chamberview.py \
    ...
    --raw_line "profile_link 1.1 STA-AUTO 5 'DUT: $DUT_NAME Radio-2' NA wiphy0,AUTO         -1 NA"


# 3. RUN 'WiFi Capacity' TEST
#
# See README in same directory for instructions on building a
# Chamber View scenario with the 'lf_wifi_capacity_test.py' script.
printf "Starting WiFi Capacity test"

$LF_PY_SCRIPTS/lf_wifi_capacity_test.py \
    --mgr                 $MGR \
    --port                $MGR_PORT \
    --lf_user             "lanforge" \
    --lf_password         "lanforge" \
    --instance_name       "wct-instance" \
