...
#
# PURPOSE:
#   Automation script to run the 'Rate_vs_Range' Chamber View test.
#
# USAGE:
#   ./Rate_vs_Range.bash
#
...
#     - Runs the 'Rate_vs_Range' test, saving generated reports
#
...
TEST_CFG=Rate_vs_Range.cfg                      # 'Rate_vs_Range' test config file. If not specified in test script
                                            # CLI, then any unspecified options will use default test values.

RPT_DIR=/tmp/Rate_vs_Range_reports              # Output directory for generated reports and associated data

# Chamber View Scenario name
CV_SCENARIO_NAME=Rate_vs_Range_Automated_Test
...
DUT_NAME=Rate_vs_Range_DUT                      # Name of DUT as it appears in report
...
# 3. RUN 'Rate_vs_Range' TEST
#
# See README in same directory for instructions on building a
# Chamber View scenario with the 'lf_rvr_test.py' script.
printf "Starting Rate_vs_Range test"

# TODO: `--station` selection is hardcoded
$LF_PY_SCRIPTS/lf_rvr_test.py \
    --mgr                 $MGR \
    --port                $MGR_PORT \
    --lf_user             "lanforge" \
    --lf_password         "lanforge" \
    --instance_name       "rvr-instance" \
