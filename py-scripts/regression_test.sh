...
if (( ${mgrlen} > 0 )); then
  ...
  testCommands=(
      ...
      "./test_fileio.py --macvlan_parent eth1 --num_ports 3 --use_macvlans --first_mvlan_ip 192.168.92.12 --netmask 255.255.255.0 --gateway 192.168.92.1 --mgr $MGR" # Better tested on Kelly, where VRF is turned off
  ...
  testCommands=(
      ...
      "./test_fileio.py --macvlan_parent eth1 --num_ports 3 --use_macvlans --first_mvlan_ip 192.168.92.12 --netmask 255.255.255.0 --gateway 192.168.92.1" # Better tested on Kelly, where VRF is turned off
