 ...
 ** FURTHER INFORMATION **
    ...
    optional.add_argument('--influx_mgr',
                        ...
                        default=None)
    optional.add_argument('--use_existing_sta', help='Used an existing stations to a particular AP', action='store_true')
    optional.add_argument('--sta_names', help='Used to force a connection to a particular AP', default="sta0000")
    # optional.add_argument('--add_trf', '--additional_traffic', nargs="+", default=None,
    #                     help='Provide information about upstream,Radio,SSID,security,password for traffics to run on multiple'
    #                          ' upstream ports, e.g1: --additional_traffic eth2,radio,ssid_of_ap_on_eth2,ap_security,ap_password'
    #                          'e.g2: --additional_traffic eth2,wiphy0,SSID,wpa2,Password@123')
