...
class lf_create_radio_frame():
    def __init__(self, rig_tab, rig_frame, max_radios, window_tooltip, current_working_directory):
        ...
        self.radio_canvas = tkinter.Canvas(self.lf_radio_frame, width=1400, height=360)
        ...
        self.lf_read_radio.grid(row=0, column=4, sticky="news", padx=20, pady=10)
        ...
        self.lf_apply_radio.grid(row=0, column=5, sticky="news", padx=20, pady=10)
        ...
        self.lf_clear_radio.grid(row=0, column=6, sticky="news", padx=20, pady=10)
        ...
        self.radio_2g_label.grid(row=1, column=1)

        self.radio_5g_label = tkinter.Label(self.radio_content_frame, text="5g")
        self.radio_5g_label.grid(row=1, column=2)
        ...
        for radio in range(0, self.max_radios):
            ...
            use_radio_2g_check = tkinter.Checkbutton(self.radio_content_frame, text="2g", variable=self.use_radio_2g_var_dict[radio],
                                                     onvalue="Use", offvalue="Do Not Use")
            use_radio_2g_check.grid(row=radio + 2, column=1)
...
or deselect to remove from the test json''')
            ...
            use_radio_5g_check = tkinter.Checkbutton(self.radio_content_frame, text="5g", variable=self.use_radio_5g_var_dict[radio],
                                                     onvalue="Use", offvalue="Do Not Use")
            use_radio_5g_check.grid(row=radio + 2, column=2)
...
or deselect to remove from the test json''')
            ...
            use_radio_6g_check = tkinter.Checkbutton(self.radio_content_frame, text="6g", variable=self.use_radio_6g_var_dict[radio],
                                                     onvalue="Use", offvalue="Do Not Use")
            use_radio_6g_check.grid(row=radio + 2, column=3)
...
or deselect to remove from the test json''')
    ...
    def get_lanforge_radio_information(self):
        ...
        for key in self.lanforge_radio_json:
            if 'wiphy' in key:
                ...
                self.radio_port_dict[radio].set(self.lanforge_radio_json[key]['port'])
    ...
    def clear_lanforge_radio_information(self):
        ...
        for radio in range(0, self.max_radios):
            ...
            self.radio_port_dict[radio].set("")
