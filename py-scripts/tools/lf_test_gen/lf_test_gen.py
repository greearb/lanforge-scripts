...
class json_gen_gui():
    ...
    def __init__(self,
        ...
        self.lf_rig_tab = lf_rig_tab.lf_create_rig_tab(self.rig_tab, self.window_tooltip, self.current_working_directory) 
...
#
        ...
        lf_dut_tab.lf_create_dut_tab(self.dut_tab, self.window_tooltip, self.current_working_directory) 
...
#
        ...
        #self.window_tooltip.bind(self.lf_wc_sta_profile_combobox, '''Station profile,  when using stations greater then 1 ,MU MIMO #will perform poor for AX radios for virtual stations greater then one, use STA-AC''')
#
...
#
        ...
        #self.window_tooltip.bind(self.lf_wc_use_qa_check, '''Recommended: Wifi Capacity Test Suite Json will include lf_qa.lf_qa wi#ll compare performance over multiple runs for Chamber View tests and tests that include kpi''')
#
        ...
        #self.window_tooltip.bind(self.lf_wc_use_inspect_check, '''Recommended: Wifi Capacity Test Suite Json will include lf_inspect.lf_inspe#ct will compare performance between two individual runs for Chamber View tests and tests that include kpi''')
#
...
#
    def get_lanforge_radio_information(self):
        ...
        # access data
        request_command = 'http://{lfmgr}:{port}/radiostatus/all'.format(lfmgr=self.lf_rig_tab.lf_mgr_entry_var.get(),
                                                                         port=self.lf_rig_tab.lf_mgr_port_entry_var.get())
        request = requests.get(request_command, auth=(self.lf_rig_tab.lf_user_entry_var.get(), self.lf_rig_tab.lf_passwd_entry_var.get()))
