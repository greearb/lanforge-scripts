#!/usr/bin/env python3
"""----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- ----- -----
    Generated by LANforge JsonApiPythonGenerator, Fri Aug 13 12:39:58 PDT 2021
        - - WORK IN PROGRESS - -
        ...
        def set_flags(cls, starting_value: int, flag_names=None):
            ...
            if type(flag_names) is list:
                ...
                for flag in flag_names:
                    ...
                    selected_flags.extend([cls[member].value for member in cls.__members__ if member == flag])
